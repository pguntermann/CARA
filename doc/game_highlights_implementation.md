...
The system includes 19 rules covering various aspects of chess:
...
3. Post-Processing
   ...
   - Limit per phase (default: 7 highlights per phase)

4. Final Output
   - Combine highlights from all phases
   - Sort by move number for chronological display

5.2 Cross-Phase Priority Adjustment
...
- Only apply penalty if >7 highlights available in current phase
...
4. Deduplicate
5. Take top N per phase (default: 7)
...
9. FEN-Based Positional Analysis
...
10. Integration with GameSummaryService
...
- Machine learning for highlight ranking
- User preference learning (which highlights are most useful)
- Configurable priority adjustments
- Highlight categories/tags for filtering
- Highlight explanations/annotations
