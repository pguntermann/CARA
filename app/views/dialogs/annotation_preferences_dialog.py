...
class AnnotationPreferencesDialog(QDialog):
    ...
    def _load_config(self) -> None:
        ...
        self.help_manual_anchor = str(help_config.get('manual_anchor', 'annotation-preferences'))
    ...
    def _build_help_button(self) -> QToolButton:
        """Themed manual help button for the top-right of the Color Palette row."""
    ...
    def _on_help_clicked(self) -> None:
        open_user_manual(
            ...
            context="annotation_preferences.help",
        )
