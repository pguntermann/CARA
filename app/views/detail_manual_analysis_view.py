                ...
                try:
                    ...
                    if main_window and hasattr(main_window, 'controller'):
                        ...
                        if error_type == "no_engines":
                            ...
                            message = "Please add at least one UCI chess engine before starting manual analysis.<br><br>Go to Engines → Add Engine... to configure an engine."
                            message += '<br><br><a href="manual://adding-first-engine">Learn how to add an engine</a>'
                        else:
                            title = "No Engine Assigned"
                            message = "Please assign an engine to the Manual Analysis task before starting analysis.<br><br>Go to Engines → [Engine Name] → Assign to Manual Analysis."
