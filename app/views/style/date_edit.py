...
def generate_date_edit_stylesheet(
    ...
    """Generate QSS stylesheet for QDateEdit, QTimeEdit, and QDateTimeEdit widgets.
    ...
    # Base stylesheet
    stylesheet = (
        f"QDateEdit, QTimeEdit, QDateTimeEdit {{"
        ...
        f"}}"
        f"QDateEdit:disabled, QTimeEdit:disabled, QDateTimeEdit:disabled {{"
...
def apply_date_edit_styling(
    ...
    """Apply styling to QDateEdit, QTimeEdit, and QDateTimeEdit widgets.
    ...
    Args:
        ...
        disabled_brightness_factor: Brightness factor for disabled state (default: 0.5).
    """
    stylesheet = generate_date_edit_stylesheet(
